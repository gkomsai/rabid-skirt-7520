...
export const multiData = [
  {
    ...
    product_colors: [
      ...
      {
        hex_value: "#AF0C45",
        colour_name: "Heartbreaker",
      },
      {
        hex_value: "#7A1B53",
        colour_name: "Obsessed",
      },
      {
        hex_value: "#7B1B40",
        colour_name: "Victorian",
      },
      {
        hex_value: "#4C091A",
        colour_name: "Nightrunner",
      },
      {
        hex_value: "#572316",
        colour_name: "Invasion",
      },
      {
        hex_value: "#E9361F",
        colour_name: "Revolt",
  ...
  },
  {
    ...
    product_colors: [
      ...
      {
        hex_value: "#670C13",
        colour_name: "Bad Girl",
      },
      {
        hex_value: "#512C33",
        colour_name: "Night Walker",
      },
      {
        hex_value: "#1A1929",
        colour_name: "Rebel",
      ...
      {
        hex_value: "#071C13",
        colour_name: "Bad Seed",
      },
      {
        hex_value: "#201913",
        colour_name: "Femme Fatale",
      },
    ],
  },
  {
    ...
    product_type: "lipstick",
    tag_list: [],
    created_at: "2017-12-24T02:25:55.235Z",
    updated_at: "2017-12-24T02:25:55.925Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/857.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/857/original/open-uri20171224-4-4k5tpf?1514082354",
    product_colors: [
      {
        hex_value: "#CAA6A8",
        colour_name: "The New Normal",
      },
      {
        hex_value: "#E8BBBE",
        colour_name: "Booming",
      ...
      {
        hex_value: "#DBACA4",
        colour_name: "Spring It On",
      },
      {
        hex_value: "#E6B06A",
        colour_name: "Cocktail Party",
      },
      {
        hex_value: "#EFA367",
        colour_name: "Fairplay",
      },
      {
        hex_value: "#E0DBD5",
        colour_name: "Crushing It",
      },
      {
        hex_value: "#BE9CAD",
        colour_name: "Gypsy Dream",
      },
      {
        hex_value: "#A8C0C2",
        colour_name: "Day Club",
      },
      {
        hex_value: "#D3CCB9",
        colour_name: "Lucid",
  ...
  },
  {
    ...
    description:
      "Give your cheeks a sun kissed glow with Fake Bake Blush in Legal Sunburn. Paraben Free. Brush the powder blush over your cheeks, nose, and brow arches, and instantly wake up a tired or pale face.\nThe naturally derived red and pink hues give you a fresh, sexy color-minus the skin damage.Ingredients: Mica, Talc, Nylon-12, Ethylhexyl Palmitate, Parafinum Liquidum, Petrolatum, Kaolin, Magnesium Stearate, Tocopheryl Acetate, Caprylic/Capric, Triglyceride, Silica, Phenoxyethanol, Proctone Olamine, [may contain ( +/-): C!75470, CI77891, CI77499, CI45410:2, CI77492, CI19140:1]",
    rating: 5,
    category: "powder",
    product_type: "blush",
    tag_list: [],
    created_at: "2016-10-01T18:35:36.689Z",
    updated_at: "2017-12-23T21:08:47.614Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/475.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/475/original/data?1514063327",
    product_colors: [],
  },
  {
    id: 473,
    ...
    website_link: "https://well.ca",
    description:
      "Never stop blushing with CoverGirl New truBLEND blush! Features:New marbled baked formulaUltra-blendable and delivers a beautiful, multi-toned result Designed to fit light, medium and deep skin tones alikeHow to Apply: Step 1: Lightly dip brush into blush, then tap or blow off excess powder. Step 2: Next, sweep the blush over and under your cheekbone to create a beautiful, rosy looking flush. ",
    rating: null,
    category: "powder",
    product_type: "blush",
    tag_list: [],
    created_at: "2016-10-01T18:35:34.299Z",
    updated_at: "2017-12-23T21:08:47.473Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/473.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/473/original/open-uri20171223-4-11ptefh?1514063327",
    product_colors: [],
  },
  {
    id: 730,
    ...
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/730.json",
    api_featured_image:
  ...
  },
  {
    ...
    product_colors: [
      {
        hex_value: "#251414",
        colour_name: "Deep Creek ",
      },
      {
        hex_value: "#521B3E",
        colour_name: "Canadian Wildberries ",
      },
      {
        hex_value: "#A99483",
        colour_name: "Double Double ",
      },
      {
        hex_value: "#C4658F",
        colour_name: "Lunching In Yorkville ",
      },
      {
        hex_value: "#8C0002",
  ...
  },
  {
    ...
    product_type: "lipstick",
    tag_list: [],
    created_at: "2017-12-24T02:25:52.691Z",
    updated_at: "2017-12-24T02:26:11.159Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/856.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/856/original/open-uri20171224-4-n7nifg?1514082369",
    product_colors: [
      {
        hex_value: "#D7978E",
        colour_name: "I Woke Up Like This",
      },
      {
        hex_value: "#B98180",
        colour_name: "Entice",
      ...
      {
        hex_value: "#8B4B4C",
        colour_name: "Bang Bang",
      },
      {
        hex_value: "#FF56A8",
        colour_name: "Baecation",
      },
      {
        hex_value: "#B73E8D",
        colour_name: "Fatal Attraction",
      },
      {
        hex_value: "#974AB4",
        colour_name: "Feisty",
      ...
      {
        hex_value: "#921736",
        colour_name: "Fire Dancer",
      },
      {
        hex_value: "#A1745D",
        colour_name: "Beyond Basic",
      },
      {
        hex_value: "#D3212F",
        colour_name: "Red Queen",
      },
      {
        hex_value: "#FF6964",
        colour_name: "Breezy",
  ...
  },
  {
    ...
    product_type: "lipstick",
    tag_list: [],
    created_at: "2017-12-24T02:25:49.754Z",
    updated_at: "2017-12-24T02:26:23.322Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/855.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/855/original/open-uri20171224-4-10m51gg?1514082383",
    product_colors: [
      {
        hex_value: "#BC7D5A",
        colour_name: "Exposed",
      ...
      {
        hex_value: "#563428",
        colour_name: "Neat Nude",
      },
      {
        hex_value: "#A91851",
        colour_name: "Buzzkill",
      },
      {
        hex_value: "#9E1F26",
        colour_name: "Acme",
      ...
      {
        hex_value: "#7A253A",
        colour_name: "Modern Maven",
      },
      {
        hex_value: "#761538",
        colour_name: "Pure Society",
      },
      {
        hex_value: "#752329",
        colour_name: "Biker Babe",
      },
      {
        hex_value: "#472071",
        colour_name: "Ego",
  ...
  },
  {
    ...
    product_type: "lipstick",
    tag_list: [],
    created_at: "2017-12-24T02:25:43.772Z",
    updated_at: "2017-12-24T02:26:27.212Z",
    product_api_url:
      "https://makeup-api.herokuapp.com/api/v1/products/853.json",
    api_featured_image:
      "//s3.amazonaws.com/donovanbailey/products/api_featured_images/000/000/853/original/open-uri20171224-4-107hboe?1514082386",
    product_colors: [
      {
        hex_value: "#F8AB8F",
        colour_name: "Cheekies",
      },
      {
        hex_value: "#E59886",
        colour_name: "Silk Indulgent",
      },
      {
        hex_value: "#C48B7A",
        colour_name: "Baby Doll",
      ...
      {
        hex_value: "#AF7260",
        colour_name: "Bedtime Flirt",
      },
      {
        hex_value: "#AF7079",
        colour_name: "Embellishment",
      },
      {
        hex_value: "#BF7D6F",
        colour_name: "Cashmere Silk",
      },
      {
        hex_value: "#A9796F",
        colour_name: "Bustier",
      ...
      {
        hex_value: "#C07764",
        colour_name: "Ruffle Trim",
      },
      {
        hex_value: "#E29871",
        colour_name: "Dusk To Dawn",
      },
      {
        hex_value: "#C59581",
        colour_name: "Satin Ribbon",
      },
      {
        hex_value: "#C0947B",
        colour_name: "Corset",
      ...
      {
        hex_value: "#966F60",
        colour_name: "Delicate Lust",
      },
      {
        hex_value: "#96705D",
        colour_name: "Honeymoon",
      },
      {
        hex_value: "#8F624D",
        colour_name: "Teddy",
      ...
      {
        hex_value: "#8B5845",
        colour_name: "After Hours",
      },
      {
        hex_value: "#855A4A",
        colour_name: "Beauty Mark",
      },
      {
        hex_value: "#715E50",
        colour_name: "Scandalous",
      },
    ],
  },
  {
